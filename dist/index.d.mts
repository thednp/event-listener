...
type PossibleEventTarget = EventTarget & (Element | Document | Window | MediaQueryList);
type EventRegistryEntry<T = EventTarget, H = NativeEventHandler<T>> = Map<H, AddEventListenerOptions | undefined | boolean>;
type EventsRegistry = Record<string, Map<PossibleEventTarget, EventRegistryEntry<PossibleEventTarget>>>;
//#endregion
//#region src/index.d.ts
declare const registry: EventsRegistry;
/**
 * The global event listener.
 *
 * @see https://developer.mozilla.org/en-US/docs/Web/API/Event/currentTarget
 */
declare const globalListener: (e: NativeEvent) => void;
/**
 * Register a new listener with its options and attach the `globalListener`
 * to the target if this is the first listener.
 */
declare const addListener: <T extends PossibleEventTarget, L = EventListener>(element: T, eventType: string, listener: L, options?: AddEventListenerOptions) => void;
/**
 * Remove a listener from registry and detach the `globalListener`
 * if no listeners are found in the registry.
 */
declare const removeListener: <T extends PossibleEventTarget, L = EventListener>(element: T, eventType: string, listener: L, options?: AddEventListenerOptions) => void;
declare const on: typeof addListener;
